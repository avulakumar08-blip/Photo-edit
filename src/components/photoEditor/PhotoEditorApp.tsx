...
interface PhotoEditorAppProps {
  onSwitchToPuzzle?: () => void;
}

export const PhotoEditorApp: React.FC<PhotoEditorAppProps> = ({ onSwitchToPuzzle }) => {
        ...
        <div className="flex items-center space-x-2">
          {onSwitchToPuzzle && (
            <button
              ...
              className="flex items-center gap-1.5 bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-500 hover:to-violet-500 text-white font-medium px-3 py-1.5 rounded-lg shadow-sm transition active:scale-95 text-xs mr-1"
            >
              <Brain className="w-3.5 h-3.5" />
              <span>Puzzle Studio</span>
            </button>
          )}
